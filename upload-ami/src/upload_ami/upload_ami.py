...
def upload_ami(
    ...
    """
    Register a NixOS AMI from a snapshot and return the image ids for each region.

    The snapshot must already exist (created by coldsnap or similar).
...
def main() -> None:
    ...
    parser.add_argument("--snapshot-id", help="EBS snapshot ID", required=True)
